...
def test_zakaz_20_strict_adjacency():
    ...
    print(f"Заказ ZAKAZ_row_20 содержит 4 полигона")
    print(f"MAX_SHEETS_PER_ORDER = 7")
    ...
    if zakaz_20_sheets:
        ...
        if sheet_range <= MAX_SHEETS_PER_ORDER and max_sheet <= expected_max_sheet:
            print(f"✅ ТЕСТ ПРОЙДЕН: Ограничение MAX_SHEETS_PER_ORDER соблюдено")
            ...
            print(f"❌ ТЕСТ НЕ ПРОЙДЕН: Нарушение ограничения MAX_SHEETS_PER_ORDER")
