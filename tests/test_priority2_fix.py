...
def create_test_data():
    ...
    # Имитируем 37 заказов из sample_input_test.xlsx с разными размерами
    excel_orders = [
...
def main():
    ...
    if problems:
        ...
        for problem in problems:
            print(f"   • {problem}")
        print("\n🔧 Рекомендации:")
        print("   • Проверить логику приоритета 2 для серых листов")
        print("   • Убедиться что алгоритм доходит до листов начиная с 18")
        print("   • Снизить порог заполнения для приоритета 2 еще больше")
        return False
    else:
        print("\n✅ ПРОБЛЕМЫ ИСПРАВЛЕНЫ!")
