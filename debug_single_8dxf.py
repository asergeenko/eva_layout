...
def test_single_8dxf():
    ...
    try:
        ...
        print("🔍 Testing SINGLE carpet 8.dxf placement")
        ...
        placed_layouts, unplaced = bin_packing_with_inventory(
            [carpet], available_sheets, verbose=True
        )
        ...
        if placed_layouts and len(placed_layouts) > 0:
            ...
            if layout.placed_polygons:
                ...
                if placed_carpet.angle == 0:
                    print(
                        "❌ Original orientation (0°) was chosen - tetris might not be working"
                    )
                elif placed_carpet.angle == 90 or placed_carpet.angle == 270:
                    print(
                        "🎯 ✅ 90°/270° rotation was chosen - tetris algorithm worked!"
                    )
