...
def test_subaru_duplication():
    ...
    print(f"=== ТЕСТ ДУБЛИРОВАНИЯ SUBARU FORESTER ===")
    print(f"Полигонов: {len(polygons)}")
    print(f"SUBARU файлы: SUBARU FORESTER 2_1.dxf, SUBARU FORESTER 2_2.dxf, SUBARU FORESTER 2_3.dxf, SUBARU FORESTER 2_4.dxf")  
