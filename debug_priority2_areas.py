...
print(
    f"Priority 1 (14 ковров): {total_priority1_area:.0f} mm² ≈ {total_priority1_area/100:.0f} см²"
)
print(
    f"Priority 2 (15 ковров): {total_priority2_area:.0f} mm² ≈ {total_priority2_area/100:.0f} см²"
)
print(
    f"Общая площадь всех ковров: {(total_priority1_area + total_priority2_area):.0f} mm² ≈ {(total_priority1_area + total_priority2_area)/100:.0f} см²"
)
...
theoretical_utilization = (
    (total_priority1_area + total_priority2_area) / sheet_area
) * 100
